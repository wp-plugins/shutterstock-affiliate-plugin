        ...
        // <editor-fold defaultstate="collapsed" desc="  S E T T I N G S       C O N T E N T   ">
                ...
                function settings_shutter_page(){
                    ...
                    if ( isset($_POST['login_name_shutterstock']) ) {
                          ...
                          update_option( 'shutterstock_nothing_found' , $_POST['shutterstock_nothing_found'] );
                          update_option( 'shutterstock_nothing_found_keyword' , $_POST['shutterstock_nothing_found_keyword'] );
                          update_option( 'shutterstock_nothing_found_contributor' , $_POST['shutterstock_nothing_found_contributor'] );
                          update_option( 'shutterstock_nothing_found_keyword_for_contributor' , $_POST['shutterstock_nothing_found_keyword_for_contributor'] );
                          update_option( 'shutterstock_nothing_found_keyword_std' , $_POST['shutterstock_nothing_found_keyword_std'] );
                    ...
                    $shutterstock_nothing_found = get_option('shutterstock_nothing_found');
                    $shutterstock_nothing_found_keyword = get_option('shutterstock_nothing_found_keyword');
                    $shutterstock_nothing_found_contributor = get_option('shutterstock_nothing_found_contributor');
                    $shutterstock_nothing_found_keyword_for_contributor = get_option('shutterstock_nothing_found_keyword_for_contributor');
                    $shutterstock_nothing_found_keyword_std = get_option('shutterstock_nothing_found_keyword_std');
                          ...
                          <div <?php $my_close_open_win_id = 'shutterstock_meta_settings_2'; ?>
                              ...
                              <div title="<?php _e('Click to toggle','shutterstock'); ?>" class="handlediv"
                                ...
                                <table class="form-table"><tbody>
                                        ...
                                        <tr valign="top">
                                            <th scope="row"><label for="shutterstock_nothing_found" ><?php _e('If nothing is found', 'shutterstock'); ?>:</label></th>
                                            <td>
                                                <select  id="shutterstock_nothing_found" name="shutterstock_nothing_found" style="width:150px;float:left;margin:3px 10px 0px 0px;"
                                                         onchange="javascript:
                                                             if (this.value == 'keyword') document.getElementById('div_shutterstock_nothing_found_keyword').style.display='block';
                                                             else document.getElementById('div_shutterstock_nothing_found_keyword').style.display='none';
                                                             if (this.value == 'contributor') document.getElementById('div_shutterstock_nothing_found_contributor').style.display='block';
                                                             else document.getElementById('div_shutterstock_nothing_found_contributor').style.display='none';
                                                             if ( (this.value == 'popular') || (this.value == 'random') || (this.value == 'newest') ) document.getElementById('div_shutterstock_nothing_found_keyword_std').style.display='block';
                                                             else document.getElementById('div_shutterstock_nothing_found_keyword_std').style.display='none';
                                                        " >
                                                    <option <?php if( ($shutterstock_nothing_found == 'nothing') ) echo "selected"; ?> value="nothing"><?php _e('Show nothing', 'shutterstock'); ?></option>
                                                    <option <?php if($shutterstock_nothing_found == 'popular') echo "selected"; ?> value="popular"><?php _e('Most Popular Images', 'shutterstock'); ?></option>
                                                    <option <?php if($shutterstock_nothing_found == 'random')  echo "selected"; ?> value="random"><?php _e('Random Images', 'shutterstock'); ?></option>
                                                    <option <?php if($shutterstock_nothing_found == 'newest')  echo "selected"; ?> value="newest"><?php _e('Newest Images', 'shutterstock'); ?></option>
                                                    <option <?php if($shutterstock_nothing_found == 'keyword') echo "selected"; ?> value="keyword"><?php _e('Images with this Keyword', 'shutterstock'); ?></option>
                                                    <option <?php if($shutterstock_nothing_found == 'contributor') echo "selected"; ?> value="contributor"><?php _e('Images from this contributor', 'shutterstock'); ?></option>
                                                    <option <?php if( ($shutterstock_nothing_found == 'error') || (empty($shutterstock_nothing_found))) echo "selected"; ?> value="error"><?php _e('Show Error Message', 'shutterstock'); ?></option>
                                                </select>

                                                <span  id="div_shutterstock_nothing_found_keyword_std" style="<?php if ( ($shutterstock_nothing_found != 'newest') && ($shutterstock_nothing_found != 'popular') && ($shutterstock_nothing_found != 'random') ) { echo "display:none;";} ?>  " >
                                                    <?php _e('Keyword(s)','shutterstock'); ?>:<input   id="shutterstock_nothing_found_keyword_std" name="shutterstock_nothing_found_keyword_std" value="<?php echo $shutterstock_nothing_found_keyword_std; ?>"
                                                         style="margin:0px 5px; width:140px !important;height:22px !important;padding:0px !important;"
                                                       />
                                                </span>

                                                <span id="div_shutterstock_nothing_found_keyword" style="<?php if ($shutterstock_nothing_found != 'keyword')  { echo "display:none;";} ?>" >
                                                   <?php _e('Keyword','shutterstock'); ?>:<input   id="shutterstock_nothing_found_keyword" name="shutterstock_nothing_found_keyword" value="<?php echo $shutterstock_nothing_found_keyword; ?>"
                                                     style="margin-right:10px; width:140px !important;height:22px !important;padding:0px !important;  "
                                                       />
                                                </span>
                                                <span id="div_shutterstock_nothing_found_contributor" style="<?php if ($shutterstock_nothing_found != 'contributor')  { echo "display:none;";} ?>" >
                                                   <?php _e('Submitter ID','shutterstock'); ?>:<input  id="shutterstock_nothing_found_contributor" name="shutterstock_nothing_found_contributor" value="<?php echo $shutterstock_nothing_found_contributor; ?>"
                                                     style="margin-right:5px; width:100px !important;height:22px !important;padding:0px !important;  "
                                                       />
                                                   <?php _e('Keyword(s)','shutterstock'); ?>:<input   id="shutterstock_nothing_found_keyword_for_contributor" name="shutterstock_nothing_found_keyword_for_contributor" value="<?php echo $shutterstock_nothing_found_keyword_for_contributor; ?>"
                                                     style="margin-right:10px; width:140px !important;height:22px !important;padding:0px !important;  "
                                                       />
                                                </span>
                                                 <br /><br />
                                                <span class="description"><?php _e('Select what to show if nothing is found', 'shutterstock');?>.</span>
                                            </td>
                                        </tr>
...
<p>It is very easy, all you need to do is to add the following Shortcode into the place where you want to have the images results:<br /><br /><center>[shutterstock keywords="dog cat"]</center><br /><br />Now replace the "dog cat" with the keyword(s) you want. Just keep in mind that the images will get pulled in real time from Shutterstock, so it may slow down the post or page where you are using it at.', 'shutterstock'); ?>
        ...
        function wpdev_shutter_activate() {
              ...
              add_option( 'shutterstock_loader_color','93904');
                ...
                add_option('shutterstock_nothing_found','error');
                add_option('shutterstock_nothing_found_keyword','');
                add_option('shutterstock_nothing_found_keyword_std','');
                add_option('shutterstock_nothing_found_contributor','');
                add_option('shutterstock_nothing_found_keyword_for_contributor','');
        ...
        function wpdev_shutter_deactivate() {
                ...
                delete_option('shutterstock_nothing_found');
                delete_option('shutterstock_nothing_found_keyword');
                delete_option('shutterstock_nothing_found_contributor');
                delete_option('shutterstock_nothing_found_keyword_std');
                delete_option('shutterstock_nothing_found_keyword_for_contributor');
